...
export default function Booking() {
   ...
   return (roomList ? (
      <div className='row w-75 mx-auto my-5'>
         ...
         <div className="col-4">
            <img src={roomList.thongTinPhim.hinhAnh} alt="" />
            ...
            <p>Tổng tiền: {danhSachGhe.reduce((previousValue, currenValue) => {
               previousValue += currenValue.giaVe;
